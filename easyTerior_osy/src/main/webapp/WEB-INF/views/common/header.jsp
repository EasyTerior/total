  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <c:if test="${ empty memResult }"> <!-- session.setAttribute("memResult", memResult); 로그인 안 함. -->
      	...
      	<li class="nav-item">
      		<a href="${ contextPath }/joinForm.do" class="nav-link"><i class="bi bi-person-plus-fill"></i><span class="px-2 align-middle">회원가입</span></a>
      	</li>
        <li class="nav-item">
        	<a href="${ contextPath }/loginForm.do" class="nav-link"><i class="bi bi-box-arrow-in-right"></i><span class="px-2 align-middle">로그인</span></a>
        </li>
      </ul>
      </c:if>
      <c:if test="${ not empty memResult }"> <!-- session.setAttribute("memResult", memResult); -->
      	...
      	<li class="nav-item">
      		<a href="${ contextPath }/updateForm.do" class="nav-link"><i class="bi bi-wrench align-middle"></i><span class="px-2 align-middle">회원정보수정</span></a>
      	</li>
        <li class="nav-item">
        	<a href="${ contextPath }/imageForm.do" class="nav-link"><i class="bi bi-camera-fill align-middle"></i><span class="px-2 align-middle">프로필사진등록</span></a>
        </li>
        <li class="nav-item">
        	<a href="${ contextPath }/logout.do" class="nav-link"><i class="bi bi-box-arrow-right align-middle"></i><span class="px-2 align-middle">로그아웃</span></a>
        </li>
      </ul>
      </c:if>
    </div>
